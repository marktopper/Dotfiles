...
() {
  ...
  # restarting zsh. Edit .docstheme.zsh and type `source $ZDOTDIR/.docstheme.zsh`.
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=063
  ...
  ###############################[ public_ip: public IP address ]###############################
  # Public IP color.
  typeset -g POWERLEVEL9K_PUBLIC_IP_FOREGROUND=047
  # Custom icon.
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=051
